  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-16">
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-center text-3xl font-bold text-slate-900 dark:text-white">Welcome back</h1>
        <p className="mt-2 text-center text-sm text-slate-500">Sign in to your FileGenie account</p>
        <form
        ...
        >
          ...
          <button type="submit" disabled={busy} className="flex w-full items-center justify-center gap-2 rounded-xl bg-violet-600 py-3 text-sm font-semibold text-white disabled:opacity-50">
          ...
          <p className="text-center text-sm text-slate-500">
            No account?{' '}
            <Link to="/signup" className="font-medium text-violet-600 dark:text-violet-400">
              Sign up
            </Link>
          </p>
        </form>
